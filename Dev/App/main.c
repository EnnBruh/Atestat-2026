...
signed main(void) {
        ...
        datafile_read(&df, "test.enn");
        datafile_put_cstring(&df, "enn|hello", "hello");
        datafile_put_i32(&df, "enn|hello|2", 2);
        datafile_put_i32(&df, "enn|hello|3", 3);
        datafile_put_i32(&df, "enn|hell|3", 3);
        datafile_write(&df, "test.enn");
        datafile_destroy(&df);
